      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Tokens consumidos con tu clave de proveedor por los borradores y
              el bot de respuesta automática. Solo se cuentan tokens — aquí no
      ...
      <CardContent className="space-y-5">
        {loading || !data ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-10 text-center text-sm text-muted-foreground">
            ...
            <p className="text-xs">
              Esto se completa a medida que el asistente redacta borradores y
          ...
          <>
            ...
            {data.truncated && (
              <p className="text-xs text-muted-foreground">
                Mostrando una ventana parcial — el uso es lo bastante alto
                como para que aquí solo se resuman los registros más
                recientes.
              </p>
            )}
          </>
